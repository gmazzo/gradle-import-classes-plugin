...
internal abstract class ImportClassesExtensionImpl @Inject constructor(
    ...
    override fun invoke(
        ...
        val extractClasses = tasks.register<Sync>("extract${discriminator.replaceFirstChar { it.uppercase() }}ImportedClasses") {
            from(extractedFiles(classesElements))
            into(layout.buildDirectory.dir("imported-classes/${discriminator.removePrefix("imported-")}"))
